...
function generateRPCMethods(constructor, apiCalls, rpc) {
  function createRPCMethod(methodName, argMap) {
    return function () {
      ...
      console.log(methodName, RpcClient.walletcallspec[methodName] );
      if (RpcClient.walletcallspec[methodName]) {
        path = '/wallet/' + arguments[0];
...
generateRPCMethods(RpcClient, Object.assign({}, RpcClient.callspec, RpcClient.walletcallspec), rpc);
